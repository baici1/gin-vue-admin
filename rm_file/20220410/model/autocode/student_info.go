...
type StudentInfo struct {
	global.GVA_MODEL
	StudentId      string `json:"studentId" form:"studentId" gorm:"column:student_id;comment:学号;"`
	...
	RealName       string `json:"realName" form:"realName" gorm:"column:real_name;comment:真实姓名;size:255;"`
