<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="项目编号" prop="projectCode" width="120" />
        <el-table-column align="left" label="项目名称" prop="projectName" width="120" />
        <el-table-column align="left" label="项目简介" prop="introduction" width="120" />
        <el-table-column align="left" label="备注" prop="remark" width="120" />
        <el-table-column align="left" label="按钮组">
            <template #default="scope">
            <el-button type="text" icon="edit" size="small" class="table-button" @click="updateProjectInfoFunc(scope.row)">变更</el-button>
